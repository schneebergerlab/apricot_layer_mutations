...
pheatmap(t(afvalues[4:24]), cluster_rows = FALSE, cluster_cols=FALSE, annotation_row = annorow[3], annotation_col = annocol[5], color=color, annotation_colors=ann_colors, show_rownames = FALSE, show_colnames=FALSE, gaps_row=c(0,0,0,7, 14), gaps_col=c(145, 155), annotation_names_row = FALSE, annotation_names_col = FALSE, filename ='/netscratch/dep_mercier/grp_schneeberger/projects/apricot_leaf/results/scdna/bigdata/variant_calling/all_sm_in_all_samples.allele_freq.png', width=5, height=3, border_color='black')
pheatmap(t(afvalues[4:24]), cluster_rows = FALSE, cluster_cols=FALSE, annotation_row = annorow[3], annotation_col = annocol[5], color=color, annotation_colors=ann_colors, show_rownames = FALSE, show_colnames=FALSE, gaps_row=c(0,0,0,7, 14), gaps_col=c(145, 155), annotation_names_row = FALSE, annotation_names_col = FALSE, filename ='/netscratch/dep_mercier/grp_schneeberger/projects/apricot_leaf/results/scdna/bigdata/variant_calling/all_sm_in_all_samples.allele_freq.pdf', width=5, height=3, border_color='black')
