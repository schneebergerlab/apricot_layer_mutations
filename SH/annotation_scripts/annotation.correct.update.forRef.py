...
def main(argv):
    ...
    ## step 1: add scipio information
    scigene = getScipio(sciFile)
    outfile1 = outdir + "/genes.to.be.updated.txt2"
    missplitDup = checkSci(scigene,updateFile,outfile1)
    ...
    print("/projects/dep_coupland/grp_schneeberger/bin/EVM_r2012-06-25/EvmUtils/gff3_file_to_proteins.pl " + outfile4 + "  " + genomeFile + " prot > " + outfile5)
...
def checkSci(sciGene,updateFile,outfile):
    fi = open(updateFile,"r")
    fo = open(outfile,"w")
    genesUp = ""
    misSplitDup = {}
