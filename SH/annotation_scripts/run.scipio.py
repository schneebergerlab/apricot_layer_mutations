...
def main(argv):
    ...
    T = 1
    try:
        opts, args = getopt.getopt(argv,"i:o:r:t:",["indir=","outdir","ref=","threads="])
...
def runSci(ref,prot,out1,out2):
    sci = "/srv/netscratch/dep_mercier/grp_schneeberger/bin/scipio/scipio-1.4/scipio.1.4.1.pl"
    yam = "/srv/netscratch/dep_mercier/grp_schneeberger/bin/scipio/scipio-1.4/yaml2gff.1.4.pl"
