...
for s in wt7 wt18 mut4 mut11_2; do
    cd ${CWD}/$s
    bsub -q normal -n 4  -R "span[hosts=1] rusage[mem=5000]" -M 6000 -oo ${s}_bamrc_q0.log -eo ${s}_bamrc_q0.err "
#        $hometools pbamrc -n 4 -b 0 -q 0 -w 0 -S -f $refcur -l $CHRBED ${s}.deduped.bam bam_read_counts_b0_q0.bt2.txt
