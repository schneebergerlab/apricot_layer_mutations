...
# Get read counts by running code in obsolete_layer_specific_dna_analysis.sh
bgsnps = {}
...
# <editor-fold desc="OBSOLETE: FUNCTION FOR GENE CONVERSION IDENTIFICATION">
...
#     # Get read-counts at SNP positions. code in obsolete_layer_specific_dna_analysis.sh
